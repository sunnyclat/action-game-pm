...
this.sonidoQuejaJugador= new Audio (Constantes.SONIDO_QUEJA_PERSONAJE);
     this.sonidoResurrecion= new Audio(Constantes.RESUREC_SONIDO);
      ...
      //   estadoAnimacion = 0;  //no se usa mas
        ...
        invPersona= new  InventarioPersonaje (  (Consumibles) ( ItemsYArmasDelJuego.obtenItem(0) )   );
...
if(!ObjetosEstaticos.inventario.obtieneConsumible().isEmpty()){
     ...
     //      System.out.println("cargue vida");
        ...
        public void cargadoVida(){
            
            
            
            int sumar=0;
            
                cargaVidaPersonaje( sumar);
