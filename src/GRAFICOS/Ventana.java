...
/*
private void configVideo(final paintVideo pv){
...
*/
    ...
    private void configurarVentana(final LectorCanvas sd) {
        ...
        //    pv.setLayout(new FlowLayout(FlowLayout.CENTER,Constantes.ANCHO_FULL_SCREEN,Constantes.ANCHO_FULL_SCREEN));
