...
public class Espada extends Armas{
    ...
    public Espada(int id, String nombre, String descripcion, int minimAtaque, int maximAtaque,
            boolean automatica, boolean penetrante, double ataquesPorSegundo,int cantidad) {
        super(id, nombre, descripcion, minimAtaque, maximAtaque, automatica, penetrante, ataquesPorSegundo,Constantes.ESPADAZO_SONIDO,cantidad );
    }
